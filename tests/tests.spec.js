...
describe('pyg latin converter', function(){
	...
	it('should convert sentence with numbers', function(done){
	...
	it('should leave any numbers alone', function(done){
	...
	it('should leave any percentage numbers alone', function(done){
	...
	it('should convert sentence with commas', function(done){
	...
	it('should handle sentences with numbers', function(done){
	...
	it('should handle sentences with commas', function(done){
